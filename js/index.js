      ...
      yAxis: [
        {
          type: "category",
          inverse: true,
          data: ["大学英语I", "高等数学", "javascript", "C++", "线性代数"],
          // 不显示y轴的线
          axisLine: {
            show: false
          },
...
// 折线图2 模块制作
  ...
  (function() {
    ...
    // 2.指定配置
    var option = {
      color: ["coral", "deepskyblue", "lightseagreen", "orangered", "yellowgreen"],
      tooltip: {
        trigger: "item",
      ...
      series: [
        {
          ...
          data: [
            { value: 98, name: "红色基因传承" },
            { value: 45, name: "理论普及宣讲" },
            { value: 32, name: "服务党政大局" },
            { value: 79, name: "就业创业实践" },
            { value: 123, name: "基层志愿服务" }
          ]
        }
      ]
    };
